...
enum VolumeImageCleaner {
    static let optOutLabel = "glassdock.clean-volumes"
    static let optOutEnvVar = "GLASSDOCK_CLEAN_VOLUMES"
    ...
    /// Returns false when opted out via `GLASSDOCK_CLEAN_VOLUMES=false` or
    /// the `glassdock.clean-volumes=false` volume label.
