...
struct RuntimeMachineArtifacts: Sendable, Equatable {
    ...
    static func locate(
        ...
        let installedShare =
            ...
            .appendingPathComponent("share/socktainer", isDirectory: true)
        let roots = [
            repositoryRoot
        ...
        let candidates =
            [
                Self(
                    helper: executableDirectory.appendingPathComponent("socktainer-vmm"),
                    ...
                    kernel: installedShare.appendingPathComponent("socktainer-vmlinux"),
                    rootDisk: installedShare.appendingPathComponent("socktainer-root.ext4")
                )
            ]
            + roots.map {
                Self(
                    helper: $0.appendingPathComponent("VMM/out/socktainer-vmm"),
                    library: $0.appendingPathComponent("VMM/out/libkrun.1.dylib"),
                    gvproxy: $0.appendingPathComponent("VMM/out/gvproxy"),
                    kernel: $0.appendingPathComponent("Guest/out/socktainer-vmlinux"),
                    rootDisk: $0.appendingPathComponent("Guest/out/socktainer-root.ext4")
                )
            }
