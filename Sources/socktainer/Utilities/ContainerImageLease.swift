...
struct ContainerImageLease: Sendable {
    static let referencePrefix = "socktainer-runtime@sha256:"
    ...
    static func reference(for digest: String) -> String {
        "socktainer-runtime@\(digest.hasPrefix("sha256:") ? digest : "sha256:\(digest)")"
    }
...
struct LiveContainerImageLeaseReconciler: ContainerImageLeaseReconciling {
    ...
    init(
        ...
        logger: Logger = Logger(label: "socktainer.image-lease-reconciler")
    ) {
